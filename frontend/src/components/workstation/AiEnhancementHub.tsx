...
const ENHANCEMENTS = [
    {
        ...
        engine: "Apex Sentinel Gateway",
        rationale: "Requires high-fidelity logic and deep cross-manuscript memory retrieval.",
        costPerHour: 0.12,
        costPerWeek: 4.80,
        costPerMonth: 19.20,
        fidelity: "High"
    },
    {
        ...
        engine: "Velocity Stream Gateway",
        rationale: "Optimized for sub-second streaming analysis and high-frequency UI updates.",
        costPerHour: 0.02,
        costPerWeek: 0.80,
        costPerMonth: 3.20,
        fidelity: "Medium"
    },
    {
        ...
        engine: "Fidelity Prose Gateway",
        rationale: "Requires supreme linguistic nuance and creative stylistic replication.",
        costPerHour: 0.25,
        costPerWeek: 10.00,
        costPerMonth: 40.00,
        fidelity: "Extreme"
    },
    {
        ...
        engine: "Apex Vision Gateway",
        rationale: "Utilizes advanced vision-to-language mapping for atmospheric translation.",
        costPerHour: 0.15,
        costPerWeek: 6.00,
        costPerMonth: 24.00,
        fidelity: "High"
    },
    {
        ...
        engine: "Industrial Ensemble",
        rationale: "Multi-gateway validation handshake for 99.9% industrial transcription accuracy.",
        costPerHour: 0.08,
        costPerWeek: 3.20,
        costPerMonth: 12.80,
        fidelity: "Industrial"
    },
    {
        ...
        engine: "Strategic Director Gateway",
        rationale: "Requires structural oversight to maintain narrative weight during repositioning.",
        costPerHour: 0.18,
        costPerWeek: 7.20,
        costPerMonth: 28.80,
        fidelity: "High"
